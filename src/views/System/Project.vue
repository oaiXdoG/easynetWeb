...
.project-card { border: 1px solid #eee; border-radius: 8px; padding: 20px; display: flex; flex-direction: column; gap: 12px; }
...
.project-info { flex: 1; }
.project-name { font-size: 16px; font-weight: 600; color: #333; margin-bottom: 4px; }
.project-code { font-size: 12px; color: #999; font-family: monospace; margin-bottom: 8px; }
.project-desc { font-size: 14px; color: #666; line-height: 1.5; }
...
.project-actions { display: flex; gap: 8px; padding-top: 12px; border-top: 1px solid #eee; }
